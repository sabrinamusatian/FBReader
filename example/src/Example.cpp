...
// const std::string Example::PageIndexParameter = "pageIndex";
...
// 		if (arguments.size() == 1) {
// 			Example &fbreader = Example::Instance();
...
Example &Example::Instance() {
	return (Example&)ZLApplication::Instance();
}

Example::Example(const std::string &bookToOpen) :
	ZLApplication("Example")
	// ,
	...
	myExampleView = new ExampleView(*context());
	setView(myExampleView);
	...
	// addAction(ActionCode::SHOW_READING, new UndoAction(Example::ALL_MODES & ~Example::BOOK_TEXT_MODE));
	// addAction(ActionCode::SHOW_LIBRARY, new SetModeAction(Example::LIBRARY_MODE, Example::BOOK_TEXT_MODE | Example::CONTENTS_MODE));
	...
	// addAction(ActionCode::ADD_BOOK, new AddBookAction(Example::BOOK_TEXT_MODE | Example::LIBRARY_MODE | Example::CONTENTS_MODE));
	// addAction(ActionCode::UNDO, new UndoAction(Example::BOOK_TEXT_MODE));
	...
	// ZLNetworkManager::Instance().setUserAgent(std::string("Example/") + VERSION);
...
//	trackStylus(true);
	...
	// 	openBook(book);
	// }
	std::cout << "Example::initWindow():214" << std::endl;
	refreshWindow();
	std::cout << "Example::initWindow():216" << std::endl;
	// ZLTimeManager::Instance().addTask(new TimeUpdater(), 1000);
}

void Example::refreshWindow() {
	std::cout << "Example::refreshWindow():221" << std::endl;
	...
	// ((PreferencesPopupData&)*myPreferencesPopupData).updateId();
 	std::cout << "Example::refreshWindow():225" << std::endl;
}

// bool Example::createBook(const ZLFile &bookFile, shared_ptr<Book> &book) {
...
// 	void run() { Example::Instance().openBookInternal(myBook); }

// private:
// 	shared_ptr<Book> myBook;
// };

// void Example::openBook(shared_ptr<Book> book) {
// 	OpenBookRunnable runnable(book);
// 	ZLDialogManager::Instance().wait(ZLResourceKey("loadingBook"), runnable);
// 	resetWindowCaption();
// }

// void Example::openBookInternal(shared_ptr<Book> book) {
// 	if (!book.isNull()) {
...
// void Example::openLinkInBrowser(const std::string &url) const {
// 	if (url.empty()) {
// 		return;
// 	}
...
// void Example::tryShowFootnoteView(const std::string &id, const std::string &type) {
// 	if (type == "external") {
...
// Example::ViewMode Example::mode() const {
// 	return myMode;
// }

// bool Example::isViewFinal() const {
// 	return myMode == BOOK_TEXT_MODE;
// }

// void Example::showLibraryView() {
...
// void Example::setMode(ViewMode mode) {
// 	if (mode == myMode) {
// 		return;
// 	}
...
// BookTextView &Example::bookTextView() const {
// 	return (BookTextView&)*myBookTextView;
// }

// void Example::showBookTextView() {
// 	setMode(BOOK_TEXT_MODE);
// }

// void Example::restorePreviousMode() {
// 	setMode(myPreviousMode);
// 	myPreviousMode = BOOK_TEXT_MODE;
// }

// bool Example::closeView() {
...
// bool Example::canDragFiles(const std::vector<std::string> &filePaths) const {
// 	switch (myMode) {
// 		case BOOK_TEXT_MODE:
// 		case FOOTNOTE_MODE:
// 		case CONTENTS_MODE:
...
// void Example::dragFiles(const std::vector<std::string> &filePaths) {
// 	switch (myMode) {
// 		case BOOK_TEXT_MODE:
// 		case FOOTNOTE_MODE:
// 		case CONTENTS_MODE:
...
// shared_ptr<ProgramCollection> Example::webBrowserCollection() const {
// 	return myProgramCollectionMap.collection("Web Browser");
// }

// shared_ptr<Book> Example::currentBook() const {
// 	return myModel->book();
// }

// void Example::invalidateNetworkView() {
// 	((NetworkView &) *myNetworkLibraryView).invalidate();
// }

// void Example::invalidateAccountDependents() {
